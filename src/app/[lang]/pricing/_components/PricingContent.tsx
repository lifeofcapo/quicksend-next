    ...
    <div className={theme === 'dark' ? 'dark' : ''}>
      <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors">
        <main className="pt-24 pb-32 px-4 relative">
          ...
          <div className="container mx-auto max-w-7xl relative z-20 mt-24">
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                      {lang === 'ru' 
                        ? 'Оплачивайте безопасно через PayPal. Ваши платежные данные защищены мировым лидером в онлайн-платежах.' 
                        : 'Pay securely through PayPal. Your payment details are protected by the world leader in online payments.'}
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-1">
                          {lang === 'ru' ? 'Защита покупателя' : 'Buyer Protection'}
                        </h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {lang === 'ru'
                            ? 'Полная защита вашей покупки. Возврат средств в случае проблем с подпиской.'
                            : 'Full purchase protection. Money back guarantee if there are issues with your subscription.'}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-1">
                          {lang === 'ru' ? 'Несколько способов оплаты' : 'Multiple Payment Methods'}
                        </h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {lang === 'ru'
                            ? 'Оплачивайте кредитной картой, дебетовой картой или через PayPal баланс.'
                            : 'Pay with credit card, debit card, or through your PayPal balance.'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span>
                        {lang === 'ru'
                          ? 'SSL шифрование • 256-битная защита'
                ...
                <div className="bg-linear-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-900/50 rounded-xl p-8 border border-gray-200/30 dark:border-gray-700/30">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                      {lang === 'ru' ? 'Выберите план для оплаты' : 'Select Plan for Payment'}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      {lang === 'ru'
                        ? 'Начните использовать QuickSend сразу после оплаты'
                        : 'Start using QuickSend immediately after payment'}
                    </p>
                  </div>
                    ...
                    <button className="group relative w-full py-4 rounded-lg font-semibold transition-all duration-300 overflow-hidden bg-linear-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:from-yellow-500 hover:via-yellow-600 hover:to-yellow-700 text-gray-900">
                      ...
                      <div className="relative flex items-center justify-center gap-3">
                        <div className="font-bold text-lg">
                          {lang === 'ru' ? 'Оплатить через PayPal' : 'Subscribe with PayPal'}
                        </div>
                    ...
                    <div className="text-center pt-4 border-t border-gray-200/50 dark:border-gray-700/50">
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="#" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                          {lang === 'ru' ? 'Условиями обслуживания' : 'Terms of Service'}
                        </a>
                      </p>
                      <div className="mt-2 flex items-center justify-center gap-2 text-xs text-gray-500 dark:text-gray-500">
                        ...
                        <span>
                          {lang === 'ru'
                            ? 'Ваши платежные данные никогда не хранятся на наших серверах'
