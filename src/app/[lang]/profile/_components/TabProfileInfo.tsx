...
export default function TabProfileInfo({ user, userData }: TabProfileInfoProps) {
  ...
  const avatarSrc = userData?.avatar_url || user?.image || '/default-avatar.png';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-6">
        ...
        <div className="flex-1 text-center sm:text-left min-w-0">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 text-sm sm:text-base truncate">
