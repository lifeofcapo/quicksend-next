    ...
    loading: () => (
      <div className="w-full h-[300px] lg:h-[600px] flex items-center justify-center">
        <div className="relative">
          <div className="w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-blue-100/20 to-cyan-100/20 dark:from-blue-900/10 dark:to-cyan-900/10 rounded-full blur-2xl"></div>
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        ...
        {/* Анимация/иллюстрация — на мобиле показываем компактную версию иконок */}
          ...
          {showAnimation ? (
            ...
            <div className="w-full max-w-xs mx-auto py-4">
              <div className="relative">
                ...
                <div className="relative w-48 h-48 mx-auto rounded-3xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 shadow-xl flex items-center justify-center">
        ...
        {/* Текстовый блок — на мобиле первый */}
        <div className="flex-1 z-10 order-1 lg:order-2 w-full">
          <div className="text-center lg:text-left mb-6 md:mb-8">
            ...
            <div className="w-20 md:w-24 h-1.5 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full mx-auto lg:mx-0"></div>
          </div>
          ...
          {/* Карточки фич: 1 колонка на мобиле, 2 на md */}
